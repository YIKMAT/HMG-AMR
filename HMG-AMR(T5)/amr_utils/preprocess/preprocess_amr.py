...
import argparse
from amr_utils.preprocess.utils import annotate_file, load_spacy
...
if __name__ == '__main__':
    ...
    # run the pipeline
    OUT_FILE = "AMR2.0_train_0.01.txt"
    print("Annotating ", OUT_FILE)
    annotate_file(out_dir, OUT_FILE, out_dir, OUT_FILE + '.features', spacy_nlp)

    OUT_FILE_NOWIKI = "AMR2.0_train_0.01.txt.features"
    print("Remove wiki ", OUT_FILE_NOWIKI)
    wiki_remove_file(out_dir, OUT_FILE_NOWIKI, out_dir, OUT_FILE_NOWIKI + '.nowiki')
