...
class Inference:
    ...
    def parse_sentences(self, sentences, num_beams, num_ret_seq, index, mg_dict, mg_list):
        # Generate
        graphs_generated = self.model.generate(sentences, index, mg_dict, mg_list, num_beams=num_beams, num_ret_seq=num_ret_seq)
